...
[RequireComponent(typeof(ScannerBatteries))]
public class ScannerAdvanced : MonoBehaviour
{
    ...
    [SerializeField] private ScannerBatteries scannerBatteries;
    ...
    private void Awake()
    {
        scannerBatteries = GetComponent<ScannerBatteries>();
    }
    private void Start()
    {
...
/*    private void ChangeRadius()
    ...
    private void Scan()
    {
        ...
        scannerBatteries.IsUsingScanar = inputHandler.PressedFire;

        if (inputHandler.PressedFire)
        {
